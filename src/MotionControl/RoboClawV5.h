...
public:
    ...
    virtual bool ReadM1PositionPID(uint8_t address,float &Kp_fp,float &Ki_fp,float &Kd_fp,float &KiMax_fp,int &DeadZone,int &Min,int &Max) override;
    virtual bool ReadM2PositionPID(uint8_t address,float &Kp_fp,float &Ki_fp,float &Kd_fp,float &KiMax_fp,int &DeadZone,int &Min,int &Max) override;
	...
	virtual bool SetM1DefaultAccel(uint8_t address, int accel);
	virtual bool SetM2DefaultAccel(uint8_t address, int accel);
	...
	virtual bool ReadEncoders(uint8_t address,int &enc1,int &enc2);
	virtual bool ReadISpeeds(uint8_t address,int &ispeed1,int &ispeed2);
	...
	virtual bool SetM1MaxCurrent(uint8_t address,int max);
	virtual bool SetM2MaxCurrent(uint8_t address,int max);
	virtual bool ReadM1MaxCurrent(uint8_t address,int &max);
	virtual bool ReadM2MaxCurrent(uint8_t address,int &max);
