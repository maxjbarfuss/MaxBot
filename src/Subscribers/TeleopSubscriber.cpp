...
TeleopSubscriber::TeleopSubscriber(std::shared_ptr<MaxBotMessages::IMessageBroker> messageNode, const std::string topic, std::shared_ptr<MotionControl::VelocityControl> velocityControl)
